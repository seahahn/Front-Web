...
import { ReactComponent as SvgDecoratorBlob1 } from "Components/ServiceIntro/WebTemplate/images/svg-decorator-blob-6.svg";
import { ReactComponent as SvgDecoratorBlob2 } from "Components/ServiceIntro/WebTemplate/images/svg-decorator-blob-7.svg";
...
const DecoratorBlob2 = styled(SvgDecoratorBlob2)`
  ${tw`pointer-events-none -z-20 absolute right-0 top-0 h-64 w-64 opacity-25 transform translate-x-2/3 translate-y-1/2 fill-current text-primary-300`}
`;
  ...
  const defaultPlans = [
    {
      ...
      features: ["30 WebTemplate", "7 Landing Pages", "12 Internal Pages", "Basic Assistance"],
    },
    {
      name: "Pro Plan",
      durationPrices: ["$49", "$499"],
      mainFeature: "Suited for Production Websites",
      features: ["60 WebTemplate", "8 Landing Pages", "22 Internal Pages", "Priority Assistance", "Lifetime Updates"],
      featured: true,
    },
  ];
