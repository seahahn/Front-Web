...
import loveIllustrationImageSrc from "Components/ServiceIntro/WebTemplate/images/love-illustration.svg";
import { ReactComponent as StarIconBase } from "Components/ServiceIntro/WebTemplate/images/star-icon.svg";
import { ReactComponent as ArrowLeftIcon } from "Components/ServiceIntro/WebTemplate/images/arrow-left-3-icon.svg";
import { ReactComponent as ArrowRightIcon } from "Components/ServiceIntro/WebTemplate/images/arrow-right-3-icon.svg";
...
const ControlButton = styled.button`
  ${tw`mx-3 p-4 rounded-full transition duration-300 bg-gray-200 hover:bg-gray-300 text-primary-300 hover:text-primary-700 focus:outline-none focus:shadow-outline`}
  svg {
    ${tw`w-4 h-4 stroke-3`}
  }
`;
