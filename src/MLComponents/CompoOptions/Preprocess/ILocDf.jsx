      ...
      <div className="flex flex-row">
        <div className="flex flex-col flex-1 mr-4 space-y-2">
          ...
          <div className={classNames(isIdxRange ? "hidden" : "", "flex flex-row items-center")}>
            <label>
              인덱스 지정
              <input ref={idxRef} name={"idx"} className={inputStyle} type="number" onChange={handleChange} />
            </label>
          </div>
          <div className={classNames(isIdxRange ? "" : "hidden", "flex flex-col")}>
            <label>
              시작 인덱스
              <input name={"idx_from"} placeholder="미지정시 처음 인덱스" className={inputStyle} type="number" onChange={handleChange} />
            </label>
            <label>
              종료 인덱스
              <input name={"idx_to"} placeholder="미지정시 마지막 인덱스" className={inputStyle} type="number" onChange={handleChange} />
            </label>
          </div>
        </div>
