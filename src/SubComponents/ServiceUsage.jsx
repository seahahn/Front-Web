...
function ServiceUsage({ isOpen, setIsOpen }) {
    ...
    <div className={classNames(!isOpen && "hidden", "fixed inset-0 z-10 flex justify-center items-center")}>
      ...
      <div className="absolute w-2/5 min-h-2/5 bg-white border-2 rounded-lg flex flex-col justify-around divide-solid p-2">
        <div className="flex flex-row justify-between items-center">
          ...
          <HiX onClick={() => setIsOpen(false)} className="inline mx-2 cursor-pointer" />
        </div>
        <div className="flex flex-col space-y-2 py-4">
          ...
          <div className={classNames(modelListOpened ? "" : "hidden", "flex flex-col space-y-2 px-2")}>
            {modelList &&
              modelList.map((model) => (
