...
import { SectionHeading, Subheading as SubheadingBase } from "ServiceIntro/Templates/misc/Headings";
import { Container, ContentWithPaddingXl } from "ServiceIntro/Templates/misc/Layouts";
import loveIllustrationImageSrc from "ServiceIntro/Templates/images/love-illustration.svg";
import { ReactComponent as StarIconBase } from "ServiceIntro/Templates/images/star-icon.svg";
import { ReactComponent as ArrowLeftIcon } from "ServiceIntro/Templates/images/arrow-left-3-icon.svg";
import { ReactComponent as ArrowRightIcon } from "ServiceIntro/Templates/images/arrow-right-3-icon.svg";
...
const Description = tw.p`mt-6 text-center md:text-left text-sm md:text-base lg:text-lg font-medium leading-relaxed text-slate-100`;
...
const CustomerTitle = tw.p`font-medium text-slate-100`;
...
const ControlButton = styled.button`
  ${tw`mx-3 p-4 rounded-full transition duration-300 bg-gray-200 hover:bg-gray-300 text-teal-300 hover:text-primary-700 focus:outline-none focus:shadow-outline`}
  svg {
    ${tw`w-4 h-4 stroke-3`}
  }
`;
