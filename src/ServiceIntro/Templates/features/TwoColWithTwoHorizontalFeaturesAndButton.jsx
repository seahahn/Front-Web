...
import { PrimaryButton as PrimaryButtonBase } from "ServiceIntro/Templates/misc/Buttons";
import TeamIllustrationSrc from "ServiceIntro/Templates/images/team-illustration-2.svg";
import { ReactComponent as SvgDotPattern } from "ServiceIntro/Templates/images/dot-pattern.svg";
...
const DecoratorBlob = tw(SvgDotPattern)`w-20 h-20 absolute right-0 bottom-0 transform translate-x-1/2 translate-y-1/2 fill-current text-teal-300 -z-10`;
...
const FeatureIconContainer = styled.div`
  ${tw`mx-auto inline-block border border-primary-500 text-teal-300 text-center rounded p-2 flex-shrink-0`}
  ${(props) => [props.iconRoundedFull && tw`rounded-full`, props.iconFilled && tw`border-0 bg-teal-500 text-gray-100`]}
  svg {
    ${tw`w-5 h-5`}
  }
`;
...
export default ({
  ...
  heading = (
    <>
      Designed & Developed by <span tw="text-teal-300">Professionals.</span>
    </>
  ),
