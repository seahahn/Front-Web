...
import TeamIllustrationSrc from "ServiceIntro/WebTemplate/images/team-illustration-2.svg";
import { ReactComponent as SvgDotPattern } from "ServiceIntro/WebTemplate/images/dot-pattern.svg";
...
const DecoratorBlob = tw(SvgDotPattern)`w-20 h-20 absolute right-0 bottom-0 transform translate-x-1/2 translate-y-1/2 fill-current text-primary-300 -z-10`;
...
const FeatureIconContainer = styled.div`
  ${tw`mx-auto inline-block border border-primary-500 text-primary-300 text-center rounded p-2 flex-shrink-0`}
